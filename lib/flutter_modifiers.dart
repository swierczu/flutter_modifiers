...
extension FlutterModifiers<T extends Widget> on T {
  ...
  ///  * The [catalog of layout widgets](https://flutter.dev/widgets/layout/).
  Center center({double widthFactor = 0, double heightFactor = 0}) {
    return Center(
  ...
  ///  * The [catalog of layout widgets](https://flutter.dev/widgets/layout/).
  Baseline baseline({double baseline = 0, TextBaseline baselineType = TextBaseline.alphabetic}) {
    return Baseline(
      child: this,
      baseline: baseline,
  ...
  ///
  ///  * [The catalog of layout widgets](https://flutter.dev/widgets/layout/).
  IntrinsicWidth intrinsicWidth({double stepWidth = 0, double stepHeight = 0}) {
  ...
  /// ```
  /// {@end-tool}
  Transform translate({Offset offset = const Offset(0, 0), bool transformHitTests = true}) {
